            ...
            return watch(connectionProvider).isOnline
                ? SingleChildScrollView(
                    child: Column(
                      children: [
                        defaultHeader(
                            height: 100.h, title: 'Cart', context: context),
                        FutureBuilder(
                          future:
                              context.read(cartViewModelProvider).fetchCart(),
                ...
                : Center(child: Text('No Internet Connection' , style: TextStyle(fontSize: 18.w),));
        },
      ),
    );
  }
